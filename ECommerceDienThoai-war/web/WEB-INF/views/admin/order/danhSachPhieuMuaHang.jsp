<%-- 
    Document   : danhSachPHieuMuaHang
    Created on : Dec 16, 2017, 11:30:15 AM
    Author     : DacTien
--%>
...
<div class="row">
    <div class="col-lg-6">
        <h1 class="page-header">Quản lý phiếu mua hàng</h1>
    </div>
</div>
...
<div class="row">
    ...
    <c:forEach items="${phieuMuaHangs}" var="p">
        <tr>
            <td>${p.id}</td>
            <td>${p.idNguoiMua.hoTen}</td>
            <td>
        <fmt:formatDate value="${p.ngayDatHang}" pattern="dd-MM-yyyy" />
    </td>
    <td>
        <fmt:formatNumber value="${p.tongTien}" pattern="###,###,### VND" />
    </td>
    <td>
    ...
    <div class="panel panel-primary filterable">
        <div class="panel-heading">
            <h3 class="panel-title">Phiếu mua hàng</h3>
