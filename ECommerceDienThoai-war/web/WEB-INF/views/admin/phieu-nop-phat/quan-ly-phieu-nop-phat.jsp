<%-- 
    Document   : them-phieu-phat
    Created on : Dec 17, 2017, 10:16:28 AM
    Author     : DacTien
--%>
...
<div class="row">
    <div class="col-lg-6">
        <h1 class="page-header">Quản lý phiếu nộp phạt</h1>
    </div>
</div>
...
<div class="row">
    <div class="panel panel-primary filterable">
        <div class="panel-heading">
            <h3 class="panel-title">Phiếu nộp phạt</h3>
        ...
        <table class="table">
            <thead>
                <tr class="filters">
                    <th><input type="text" class="form-control" placeholder="Người lập" disabled></th>
            ...
            <tbody>
                <c:forEach items="${list}" var="p">
                    <tr>
                        ...
                        <td>
                            <fmt:formatDate value="${p.ngayNopPhat}" pattern="dd-MM-yyyy" />
                        </td>
                        <td>
                            <fmt:formatNumber value="${p.soTien}" pattern="###,###,### VND" />
                        </td>
<!--                        <td>
