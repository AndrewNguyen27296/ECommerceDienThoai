...
<!--                        <div class="form-group"style="border: 1px solid; border-radius: 10px">
                    ...
                    <div id="my-address" style="display: block;margin-top: 20px;">
                        <div class="form-group  col-sm-12">
                            <label class="col-sm-3 text-right my-label">Họ tên</label>
                            <input name="hoTen" value="${sessionScope.nguoiMua.hoTen}" class="form-control col-sm-7" />
                        </div>
                        <div class="form-group  col-sm-12">
                            <label class="col-sm-3 text-right my-label">Số điện thoại</label>
                            <input name="soDienThoai" value="${sessionScope.nguoiMua.soDienThoai}" class="form-control col-sm-7" />
                        </div>
                        <div class="form-group  col-sm-12">
                        ...
                        <div class="form-group  col-sm-12">
                            ...
                            <input name="diaChi" value="${sessionScope.nguoiMua.diaChi}" class="form-control col-sm-7" placeholder="Số nhà, tên đường" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="clearfix"></div>
            <button type="submit" class=" btn btn-lg btn-warning " style="left: 89.6%; position: relative">Xác nhận</button>
        </form>
    </div>
<!--    <div class="col-sm-1"></div>-->
</div>
